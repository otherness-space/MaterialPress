...
public static function materialpress_customizer_live_preview()
{
	wp_enqueue_script(
...
add_action( 'customize_preview_init' , array( 'materialpress_customize' , 'materialpress_customizer_live_preview' ) );
?>
